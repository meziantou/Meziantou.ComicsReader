...
Please read these guidelines before contributing to meziantou/Meziantou.ComicsReader:
...
If you have questions about how to use meziantou/Meziantou.ComicsReader, please open a GitHub issue.
...
- Check that new and updated code follows meziantou/Meziantou.ComicsReader's existing code formatting and naming standard
- Run meziantou/Meziantou.ComicsReader's unit tests to ensure no existing functionality has been affected
...
By contributing your code to meziantou/Meziantou.ComicsReader you grant Gérald Barré a non-exclusive, irrevocable, worldwide,
