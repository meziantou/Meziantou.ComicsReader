...
To run all .NET tests from the solution root:
...
To run npm tests for the WebReader project, navigate to the WebReader directory first:

```powershell
cd Meziantou.ComicsReader.WebReader
```

To run tests once without file watching mode:
